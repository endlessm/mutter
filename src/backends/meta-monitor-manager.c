                                                   ...
                                                   MetaOutput         *output)
{
  ...
  edid = META_MONITOR_MANAGER_GET_CLASS (manager)->read_edid (manager, output);
  if (edid == NULL)
    {
      edid_variant = NULL;
    }
...
meta_monitor_manager_record_connection_changes (MetaMonitorManager *manager,
                                                ...
                                                gsize               n_old_outputs)
{
  meta_monitor_manager_record_connect_events (manager, old_outputs, n_old_outputs);
  meta_monitor_manager_record_disconnect_events (manager, old_outputs, n_old_outputs);
}
