  ...
  for (l = meta_gpu_get_outputs (gpu); l != NULL; l = l->next)
    {
      ...
      crtc_info->transform = crtc_config->transform;
      crtc_info->crtc = crtc;
      crtc_info->layout = crtc_config->layout;
      crtc_info->mode = crtc_config->mode;
      ...
      current_width = crtc_config->mode->width;
      current_height = crtc_config->mode->height;
